...
def test_max_tokens(sampler):
    ...
    # The llama_cpp backend now tracks generated token IDs directly from generate(),
    # so the number of output tokens should match the configured max_tokens exactly.
